            ...
            <div class="wheel-wrapper" ref="wheelWrapper">
              <div class="wheel" v-for="(data,key) in pickerData" :key="key">
                <ul class="wheel-scroll">
                  <li v-for="(item,key) in data" :key="key" class="wheel-item">{{item.text}}</li>
                </ul>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    confirm () {
      ...
      this.$set(this.selectedData, 0, this.pickerSelectedIndex)
      this.$set(this.selectedData, 1, this.pickerSelectedText)
      this.$set(this.selectedData, 2, this.pickerSelectedVal)
